...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://myanidandbu:sologigabit@localhost:/d1andb?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://myanidandbu:sologigabit@localhost:3306/d1andb?new_link=true');
  }
}
...
$civicrm_root = '/Users/manuelgonzalezblanco/proyectos/anidanapp/vendor/civicrm/civicrm-core';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/Users/manuelgonzalezblanco/proyectos/anidanapp/web/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '3b9c8011b301190f7c585aa017325758');
}
...
// define( 'CIVICRM_MAIL_LOG', '/Users/manuelgonzalezblanco/proyectos/anidanapp/web/sites/default/files/civicrm/templates_c//mail.log');
// }
